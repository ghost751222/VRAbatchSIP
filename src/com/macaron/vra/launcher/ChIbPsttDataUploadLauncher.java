...
import com.macaron.vra.processor.ChIbPsttDataUploadProcessor;
import com.macaron.vra.util.DateUtil;

@Component
public class ChIbPsttDataUploadLauncher {

	private static final Logger logger = LoggerFactory.getLogger(ChIbPsttDataUploadLauncher.class);

	private static String CH_IB_TASK_SCHEDULE_CRON_EX = "0 0 * * * ?";
	
	@Autowired
	private TaskScheduler taskScheduler;
	@Autowired
	private ChIbPsttDataUploadProcessor processor;
	...
	public void launchSchedule(){
		...
		taskScheduler.schedule(hourTask, new CronTrigger(CH_IB_TASK_SCHEDULE_CRON_EX));
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			ChIbPsttDataUploadLauncher launcher = (ChIbPsttDataUploadLauncher)context.getBean(ChIbPsttDataUploadLauncher.class);
