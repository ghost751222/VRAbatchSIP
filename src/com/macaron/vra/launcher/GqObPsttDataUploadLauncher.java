...
import com.macaron.vra.processor.GqObPsttDataUploadProcessor;
import com.macaron.vra.util.DateUtil;

@Component
public class GqObPsttDataUploadLauncher {

	private static final Logger logger = LoggerFactory.getLogger(GqObPsttDataUploadLauncher.class);

	private static String GQ_OB_TASK_SCHEDULE_CRON_EX = "0 0 * * * ?";
	
	@Autowired
	private TaskScheduler taskScheduler;
	@Autowired
	private GqObPsttDataUploadProcessor processor;
	...
	public void launchSchedule(){
		...
		taskScheduler.schedule(hourTask, new CronTrigger(GQ_OB_TASK_SCHEDULE_CRON_EX));
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			GqObPsttDataUploadLauncher launcher = (GqObPsttDataUploadLauncher)context.getBean(GqObPsttDataUploadLauncher.class);
