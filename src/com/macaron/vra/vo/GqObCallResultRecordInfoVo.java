...
public class GqObCallResultRecordInfoVo {
	...
	public String toString() {
		return "GqObCallResultRecordInfoVo [dataDt=" + dataDt + ", serialNum=" + serialNum + ", callResultGroup="
				+ callResultGroup + ", callResultList=" + callResultList + ", agentDepart=" + agentDepart
				+ ", agentUnit=" + agentUnit + ", agentGroup=" + agentGroup + ", agentName=" + agentName
				+ ", agentSerialNum=" + agentSerialNum + ", contactDuration=" + contactDuration + ", customerNo="
				+ customerNo + ", contactStartDt=" + contactStartDt + ", contactEndDt=" + contactEndDt
				+ ", ctiLocation=" + ctiLocation + ", agentId=" + agentId + ", obOldMemberLevel=" + obOldMemberLevel
				+ ", productName=" + productName + ", productSerialNum=" + productSerialNum + ", orderChannel="
				+ orderChannel + ", paymentType=" + paymentType + ", paymentAmount=" + paymentAmount + ", connectionId="
				+ connectionId + ", productName2=" + productName2 + ", productSerialNum2=" + productSerialNum2
				+ ", orderChannel2=" + orderChannel2 + ", paymentType2=" + paymentType2 + ", paymentAmount2="
				+ paymentAmount2 + ", startDate=" + startDate + ", fileName=" + fileName + "]";
	}
